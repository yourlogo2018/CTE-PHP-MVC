      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
          <div class="flex-row text-center mx-auto">
            <img
              src="<?php echo $base ?>/template/assets/img/pages/forgot-password-light.png"
              alt="Auth Cover Bg color"
              width="520"
              class="img-fluid authentication-cover-img"
              data-app-light-img="pages/forgot-password-light.png"
              data-app-dark-img="pages/forgot-password-dark.png"
            />
            <div class="mx-auto">
              <h3>No worries, we will send you instructions 👩🏻‍💻</h3>
              <p>
                We can help you reset your password and security info. First, enter <br />
        ...
        <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
          <div class="w-px-400 mx-auto">
            ...
            <form  class="mb-3" action="<?php echo $base ?>/action_forgot_password" method="POST">
              <div class="mb-3">
            ...
            <div class="text-center">
              <a href="<?php echo $base ?>/login" class="d-flex align-items-center justify-content-center">
